...
const _nav = [
  ...
  {
    component: CNavItem,
    name: 'Scan untuk print',
    to: '/Scan/ScanForPrint',
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />,
    level: ['WH'],
  },
  {
    component: CNavItem,
    name: 'Scan untuk pengiriman',
    to: '/Scan/ScanForSent',
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />,
    level: ['WH'],
  },
  ...
  },
  {
    ...
    name: 'Add Brief',
    // to: '/Upload/UploadDailyTrxFile',
    to: '/MaintainKontrakKol/InputNewBrief',
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />,
    level: ['MK', 'MKSU'],
  },
  {
    ...
    name: 'List Brief',
    // to: '/Upload/UploadDailyTrxFile',
    to: '/MaintainKontrakKol/ListBrief',
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />,
    level: ['MK', 'MKSU'],
  },
  {
    component: CNavTitle,
    name: 'Maintain Kol Manager',
    level: ['MK', 'MKSU'],
  },
  {
    component: CNavItem,
    name: 'Add Manager',
    // to: '/Upload/UploadDailyTrxFile',
    to: '/MaintainKol/InputNewManager',
    icon: <CIcon icon={cilNotes} customClassName="nav-icon" />,
    level: ['MKSU'],
  },
  {
